package com.example.dialogdemoday1;
...
//                builder.setNeutralButton("Not Sure",new MyNeutralButtonClickListener());
    ...
    class DatePickerButtonClickListener implements DatePickerDialog.OnDateSetListener{
        ...
        public void onDateSet(DatePicker datePicker, int year, int month, int day) {
            Toast.makeText(MainActivity1.this,"on Date Set " + year + "--" + month + "--" + day,Toast.LENGTH_LONG).show();
        }
    }
    ...
    class TimePickerButtonClickListener implements TimePickerDialog.OnTimeSetListener{
        ...
        public void onTimeSet(TimePicker timePicker, int hour, int minute) {
            Toast.makeText(MainActivity1.this,"on Time Set" + "--" + hour + ":" + minute, Toast.LENGTH_LONG).show();
        }
    }
    ...
    class CancelClickListener implements DialogInterface.OnCancelListener{
        ...
        public void onCancel(DialogInterface dialogInterface) {
            Toast.makeText(MainActivity1.this,"Cancel Click Listener",Toast.LENGTH_LONG).show();
        }
    }
    ...
    class DismissListener implements DialogInterface.OnDismissListener{
        ...
        public void onDismiss(DialogInterface dialogInterface) {
            Toast.makeText(MainActivity1.this, "Dismiss Listener", Toast.LENGTH_LONG).show();
        }
    }
    ...
    class AlertDialogButtonsClickListener implements DialogInterface.OnClickListener{
        ...
        public void onClick(DialogInterface dialogInterface, int buttonValue) {
            if (buttonValue == -1) {
                Toast.makeText(MainActivity1.this, "Positive Button Clicked",Toast.LENGTH_LONG).show();
            } else if(buttonValue == -2){
                Toast.makeText(MainActivity1.this,"Negative Button Clicked", Toast.LENGTH_LONG).show();
            } else {
                Toast.makeText(MainActivity1.this,"Neutral Button Clicked",Toast.LENGTH_LONG).show();
            }
        }
    }
    ...
    class MyPositiveButtonClickListener implements DialogInterface.OnClickListener {
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            Toast.makeText(MainActivity1.this,"Positive Button Clicked " + i,Toast.LENGTH_LONG).show();
        }
    }
    ...
    class MyNegativeButtonClickListener implements DialogInterface.OnClickListener{
        @Override
        public void onClick(DialogInterface dialogInterface, int i) {
            Toast.makeText(MainActivity1.this,"Negative Button Clicked " + i, Toast.LENGTH_LONG).show();
        }
    }
    ...
    class MyNeutralButtonClickListener implements DialogInterface.OnClickListener{
        @Override
        public void onClick(DialogInterface dialogInterface, int i) {
            Toast.makeText(MainActivity1.this,"Neutral Button Clicked " + i, Toast.LENGTH_LONG).show();
        }
    }
}
